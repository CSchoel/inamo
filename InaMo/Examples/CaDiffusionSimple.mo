...
model CaDiffusionSimple
  ...
  InaMo.Components.IonConcentrations.DiffSimple sub_cyto(vol_src=v_sub, vol_dst=v_cyto, tau=0.04e-3);
...
annotation(
  experiment(StartTime = 0, StopTime = 0.005, Tolerance = 1e-26, Interval = 1e-6),
