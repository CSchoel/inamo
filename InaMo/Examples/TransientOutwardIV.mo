...
model TransientOutwardIV "IV relationship of I_to, recreates Figures S2E and S2F from Inada 2009"
  ...
  InaMo.Components.IonCurrents.TransientOutwardChannel to(g_max=14e-9, v_eq =k_na) // use g_max of NH model
...
annotation(
  experiment(StartTime = 0, StopTime = 520, Tolerance = 1e-6, Interval = 1e-2),
