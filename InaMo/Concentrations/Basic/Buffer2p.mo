...
model Buffer2p
  ...
  SubstanceSiteB site_b
    ...
    annotation(Placement(transformation(extent = {{85, 100}, {115, 100}})));
  ...
  Compartment occupied_b(c_start=f_b_start*n_tot/vol, vol=vol) annotation(
    Placement(transformation(origin = {90, 10}, extent = {{-10, -10}, {10, 10}})));
equation
  connect(assoc_a.ligand, site_a) annotation(Line(points = {{100, 100}, {26, 100}, {26, 15}, {36, 15}}));
  ...
  connect(assoc_b.ligand, site_b) annotation(Line(points = {{-48, 74}, {-20, 74}, {-20, 14}, {-36, 14}}));
