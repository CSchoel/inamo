...
package IonConcentrations
  ...
  model CaHandlingK "handling of Ca concentation by Kurata 2002"
    ...
    ) "Mg2+ concentration" annotation(Placement(visible = true, transformation(origin = {52, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    InaMo.Components.IonConcentrations.Compartment sub(vol=v_sub) "Ca2+ in subspace" annotation(Placement(visible = true, transformation(origin = {-82, 46}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    InaMo.Components.IonConcentrations.Compartment cyto(vol=v_cyto) "Ca2+ in cytosol" annotation(Placement(visible = true, transformation(origin = {10, -72}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    InaMo.Components.IonConcentrations.Compartment jsr(vol=v_jsr) "Ca2+ in JSR" annotation(Placement(visible = true, transformation(origin = {-16, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    InaMo.Components.IonConcentrations.Compartment nsr(vol=v_nsr) "Ca2+ in NSR" annotation(Placement(visible = true, transformation(origin = {34, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    InaMo.Components.IonConcentrations.DiffSimple sub_cyto(v_src=sub.vol, v_dst=cyto.vol, tau=0.04e-3)
      ...
      annotation(Placement(visible = true, transformation(origin = {-48, -38}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    InaMo.Components.IonConcentrations.DiffMM cyto_nsr(v_src=cyto.vol, v_dst=nsr.vol,p=0.005e3,k=0.0006)
      ...
      annotation(Placement(visible = true, transformation(origin = {18, -34}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    InaMo.Components.IonConcentrations.DiffSimple nsr_jsr(v_src=nsr.vol, v_dst=jsr.vol, tau=60e-3)
      ...
      annotation(Placement(visible = true, transformation(origin = {10, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    InaMo.Components.IonConcentrations.DiffHL jsr_sub(v_src=jsr.vol, v_dst=sub.vol, p=5e3, ka=0.0012, n=2)
      ...
      annotation(Placement(visible = true, transformation(origin = {-46, 24}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    InaMo.Components.IonConcentrations.Buffer tc(c_tot=0.031, k=88.8e3, kb=0.446e3) "troponin-Ca"
      annotation(Placement(visible = true, transformation(origin = {-14, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    InaMo.Components.IonConcentrations.Buffer2 tmc(c_tot=0.062, k=227.7e3, kb=0.00751e3) "troponin-Mg binding to Ca2+"
      annotation(Placement(visible = true, transformation(origin = {72, -72}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    InaMo.Components.IonConcentrations.Buffer2 tmm(
      c_tot=0, k=2.277e3, kb=0.751e3, // c_tot not relevant since {Mg2+]_i is constant
      redeclare connector ConcentrationType = MagnesiumConcentration
    ) "troponin-Mg binding to Mg2+" annotation(Placement(visible = true, transformation(origin = {46, -72}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    model BufferCM = InaMo.Components.IonConcentrations.Buffer(c_tot=0.045, k=227.7e3, kb=0.542e3) "base model for calmodulin";
    BufferCM cm_cyto "calmodulin in cytosol" annotation(Placement(visible = true, transformation(origin = {-8, -72}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    BufferCM cm_sub "calmodulin in subspace" annotation(Placement(visible = true, transformation(origin = {-68, 18}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    InaMo.Components.IonConcentrations.Buffer cq(c_tot=10, k=0.534e3, kb=0.445e3) "calsequestrin"
      annotation(Placement(visible = true, transformation(origin = {-34, -6}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
