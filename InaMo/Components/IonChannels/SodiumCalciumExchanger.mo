...
model SodiumCalciumExchanger
  ...
  Real di_cn = di_c * c_sub / K_cn_i;
  Real di_1n = c_sub / K_1n_i;
  Real di_2n = di_1n * c_sub / K_2n_i;
  Real di_3n = di_2n * c_sub / K_3n_i;
  ...
  Real F1_3n_i = c_sub / K_3n_i / (1 + c_sub / K_3n_i) "fraction of E";
  Real F_c_o = do_cv / do;
