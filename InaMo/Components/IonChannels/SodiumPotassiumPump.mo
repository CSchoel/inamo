...
model SodiumPotassiumPump
  ...
  parameter SI.Concentration K_m_Na = 0.621; // taken from Zhang 2000, not given in Inada 2009
  parameter SI.Concentration K_m_K = 5.64; // taken from Zhang 2000, not given in Inada 2009
equation
