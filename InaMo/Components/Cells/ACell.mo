...
equation
  ...
  connect(l2.p, naca.p);
  connect(l2.n, naca.n);
  connect(ca.cyto.c, cal.ca);
  connect(ca.cyto.c, cat.ca);
  connect(ca.cyto.c, bca.ca);
  connect(ca.cyto.c, cap.ca);
  connect(ca.cyto.c, naca.ca);
  connect(na_in.c, na.na);
  connect(na_in.c, bna.na);
  connect(na_in.c, nak.na);
  connect(na_in.c, naca.na);
  connect(k_in.c, to.k);
  connect(k_in.c, kr.k);
  connect(k_in.c, ks.k);
  connect(k_in.c, kir.k);
  connect(k_in.c, nak.k);
end ACell;
